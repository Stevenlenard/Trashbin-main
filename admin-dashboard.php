          ...
          <form id="createReportForm">
            ...
            <div class="form-group mb-3">
              ...
              <div class="form-check form-switch">
                ...
                <label class="form-check-label" for="includeCharts">Include visual charts and graphs</label>
          </div>
          </div>
            <div class="form-group mb-3">
      ...
      <div class="modal-body">
          <form id="addBinForm">
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" id="newBinId" placeholder="e.g., BIN-004" required>
            </div>
            <div class="form-group mb-3">
              <label class="form-label">Location</label>
              <input type="text" class="form-control" id="newBinLocation" placeholder="e.g., Main Street - Corner Store" required>
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              ...
              <input type="number" class="form-control" id="newBinCapacity" min="0" max="100" value="0" required>
          </div>
            <div class="form-group mb-3">
              <label class="form-label">Status</label>
            ...
            <div class="form-group mb-3">
              ...
              <select class="form-control form-select" id="newBinAssignedTo">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="editBinForm">
            ...
            <div class="form-group mb-3">
              <label class="form-label">Assign To</label>
              <select class="form-control form-select" id="editBinAssignedTo">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-body">
          <form id="addJanitorForm">
            <div class="form-group mb-3">
              <label class="form-label">Full Name</label>
              <input type="text" class="form-control" id="newJanitorName" placeholder="Enter full name" required>
            </div>
            <div class="form-group mb-3">
              <label class="form-label">Email</label>
            ...
            <div class="form-group mb-3">
              <label class="form-label">Initial Assigned Bins</label>
              <input type="number" class="form-control" id="newJanitorBins" min="0" value="0" required>
            </div>
          </form>
        </div>
        <div class="modal-footer">
